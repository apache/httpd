...
%config(noreplace) %{_sysconfdir}/httpd/conf/extra/httpd-policy.conf
...
%config(noreplace) %{_sysconfdir}/httpd/conf/original/extra/httpd-policy.conf
...
%{_libdir}/httpd/modules/mod_syslog.so
...
%{_libdir}/httpd/modules/mod_ssl_ct.so
%{_sbindir}/ctlogconfig
%{_mandir}/man8/ctlogconfig.8*
