...
curl -s $(ap1/print_address.sh)/folder1?F=J
curl -s $(ap1/print_address.sh)/folder1?F=J | grep -C10 file1.dat | grep file2.dat
curl -s $(ap1/print_address.sh)/folder1?F=J | jsonlint
