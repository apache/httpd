...
if test -f ${DESTDIR}/home/ganwang/httpd/http/bin/apr-2-config; then
   APR_CONFIG=${DESTDIR}/home/ganwang/httpd/http/bin/apr-2-config
   APU_CONFIG=${DESTDIR}
else
...
test -n "" && APU_INCLUDEDIR="`${APU_CONFIG} --includedir`"

installbuilddir="/home/ganwang/httpd/http/build"
