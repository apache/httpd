...
<xsl:output method="xml" encoding="EUC-KR" indent="no" doctype-public="-//W3C//DTD XHTML 1.0 Strict//EN" doctype-system="https://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"/>
