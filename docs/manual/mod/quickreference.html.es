...
<tr class="odd"><td><a href="mod_headers.html#errorheader">ErrorHeader set|append|add|unset|echo <var>header</var>
[<var>value</var>] [env=[!]<var>variable</var>]</a></td><td></td><td>svdh</td><td>E</td></tr><tr class="odd"><td class="descr" colspan="4">Configure HTTP response headers also for error responses</td></tr>
