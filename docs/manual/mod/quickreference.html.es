...
<tr><td><a href="core.html#keptbodysize">KeptBodySize <var>maximum size in bytes</var></a></td><td> 0 </td><td>d</td><td>C</td></tr><tr><td class="descr" colspan="4">Keep the request body instead of discarding it up to
