...
of user groups for authorization</td></tr>
<tr><td><a href="mod_authnz_ldap.html#authldapallowdnauth">AuthLDAPAllowDNAuth on|off</a></td><td> off </td><td>dh</td><td>E</td></tr><tr><td class="descr" colspan="4">Allow the user to authenticate by passing a fully distinguished
user name.</td></tr>
