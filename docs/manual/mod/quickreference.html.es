...
<tr class="odd"><td><a href="mod_auth_form.html#authformlogoutlocation">AuthFormLogoutLocation <var>uri</var></a></td><td></td><td>d</td><td>B</td></tr><tr class="odd"><td class="descr" colspan="4">The URI of the page on the server to redirect to after a user has logged out</td></tr>
...
<tr class="odd"><td><a href="request_body.html#keptbodysize">KeptBodySize <var>maximum size in bytes</var></a></td><td> 0 </td><td>d</td><td>C</td></tr><tr class="odd"><td class="descr" colspan="4">Keep the request body instead of discarding it up to
