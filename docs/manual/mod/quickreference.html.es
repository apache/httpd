...
<tr class="odd"><td><a href="mod_aspdotnet.html#aspnet">AspNet [[<var>Files</var>] [<var>Directories</var>] 
                [<var>Virtual</var>] [<var>Errors</var>]]
              | [<var>All</var>] | [<var>None</var>]</a></td><td> None </td><td>svdh</td><td><a href="http://httpd.apache.org/mod_aspdotnet/">T</a></td></tr><tr class="odd"><td class="descr" colspan="4">Enables mod_aspdotnet to process ASP.NET content</td></tr>
<tr><td><a href="mod_aspdotnet.html#aspnetmount">AspNetMount <var>URL-path</var> <var>directory-path</var></a></td><td></td><td>s</td><td><a href="http://httpd.apache.org/mod_aspdotnet/">T</a></td></tr><tr><td class="descr" colspan="4">Mounts a URI to a physical ASP.NET directory</td></tr>
<tr class="odd"><td><a href="mod_aspdotnet.html#aspnetversion">AspNetVersion <var>versionstring</var></a></td><td></td><td>s</td><td><a href="http://httpd.apache.org/mod_aspdotnet/">T</a></td></tr><tr class="odd"><td class="descr" colspan="4">Force a specific .NET Framework version to be loaded</td></tr>
...
... &lt;/AuthnProviderAlias&gt;</a></td><td></td><td>sv</td><td>B</td></tr><tr><td class="descr" colspan="4">Enclose a group of directives that represent an
...
a different URL</td></tr>
<tr class="odd"><td><a href="mod_authz_core.html#reject">Reject <var>entity-name</var> [<var>entity-name</var>] ...</a></td><td></td><td>dh</td><td>B</td></tr><tr class="odd"><td class="descr" colspan="4">Rejects which authenticated users can access
a resource</td></tr>
