...
<!--
        ...
        XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
      -->
<title>core - Servidor HTTP Apache Versi&oacute;n 2.4</title>
...
<div id="page-content">
<div id="preamble"><h1>Funcionalidad B&aacute;sica de Apache</h1>
...
<a href="../es/mod/core.html" title="Espa&ntilde;ol">&nbsp;es&nbsp;</a> |
<a href="../fr/mod/core.html" hreflang="fr" rel="alternate" title="Fran&ccedil;ais">&nbsp;fr&nbsp;</a> |
...
<div class="outofdate">Esta traducci&oacute;n podr&iacute;a estar
            ...
            recientemente.</div>
<table class="module"><tr><th><a href="module-dict.html#Description">Descripci&oacute;n:</a></th><td>Funcionalides b&aacute;sicas del Servidor HTTP Apache que siempre est&aacute;n presentes.</td></tr>
...
<h3>Lista de comprobaci&oacute;n de errores corregidos</h3><ul class="seealso"><li><a href="https://www.apache.org/dist/httpd/CHANGES_2.4">httpd historial de cambios</a></li><li><a href="https://bz.apache.org/bugzilla/buglist.cgi?bug_status=__open__&amp;list_id=144532&amp;product=Apache%20httpd-2&amp;query_format=specific&amp;order=changeddate%20DESC%2Cpriority%2Cbug_severity&amp;component=core">Problemas Conocidos</a></li><li><a href="https://bz.apache.org/bugzilla/enter_bug.cgi?product=Apache%20httpd-2&amp;component=core">Reportar un error</a></li></ul></div>

<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="acceptfilter">Directiva <span id="AcceptFilter">AcceptFilter</span> <a title="Enlace permanente" href="#acceptfilter" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Configura mejoras para un Protocolo de Escucha de Sockets</td></tr>
...
<tr><th><a href="directive-dict.html#Module">M&oacute;dulo:</a></th><td>core</td></tr>
...
En Windows desde Apache httpd 2.3.3 y posteriores.</td></tr>
    ...
    <p>Esta directiva hace posible mejoras espec&iacute;ficas a nivel de sistema operativo
       y a trav&eacute;s del tipo de Protocolo para un socket que escucha.
       La premisa b&aacute;sica es que el kernel no env&iacute;e un socket al servidor
       hasta que o bien los datos se hayan recibido o bien se haya almacenado
       en el buffer una Respuesta HTTP completa.  
       Actualmente s&oacute;lo est&aacute;n soportados
    ...
    <p>El uso de <code>none</code> para un argumento desactiva cualquier filtro 
       aceptado para ese protocolo. Esto es &uacute;til para protocolos que requieren que un
       servidor env&iacute;e datos primeros, tales como <code>ftp:</code> o <code>nntp</code>:</p>
    <div class="example"><p><code>AcceptFilter nntp none</code></p></div>

    <p>Los nombres de protocolo por defecto son <code>https</code> para el puerto 443
       y <code>http</code> para todos los dem&aacute;s puertos. Para especificar que se est&aacute;
       utilizando otro protocolo con un puerto escuchando, a&ntilde;ade el argumento <var>protocol</var>
    ...
    <p>El filtro <code>httpready</code> almacena en el buffer peticiones HTTP completas
       a nivel de kernel.  Una vez que la petici&oacute;n es recibida, el kernel la env&iacute;a al servidor. 
       Consulta la p&aacute;gina man de
       <a href="http://www.freebsd.org/cgi/man.cgi?query=accf_http&amp;sektion=9">
       accf_http(9)</a> para m&aacute;s detalles.  Puesto que las peticiones HTTPS
       est&aacute;n encriptadas, s&oacute;lo se utiliza el filtro
    ...
    <p>En Linux, <code>TCP_DEFER_ACCEPT</code> no soporta el buffering en peticiones http.
       Cualquier valor adem&aacute;s de <code>none</code> habilitar&aacute; 
       <code>TCP_DEFER_ACCEPT</code> en ese socket. Para m&aacute;s detalles 
       ver la p&aacute;gina man de Linux 
    ...
    <p>Sobre Windows mpm_winnt interpreta el argumento AcceptFilter para conmutar la API
       ...
       direcciones de red son recuperadas a partir de una &uacute;nica llamada AcceptEx().
       <code>connect</code> utiliza la API AcceptEx() API, y recupera tambi&eacute;n
       las direcciones de red, pero a diferencia de <code>none</code> 
       la opci&oacute;n <code>connect</code> no espera a la transmisi&oacute;n inicial de los datos.</p>

    <p>Sobre Windows, <code>none</code> prefiere accept() antes que AcceptEx()
       y no recuperar&aacute; sockets entre las conexiones.  Lo que es &uacute;til para los adaptadores de
       red con un soporte precario de drivers, as&iacute; como para algunos proveedores de red
       tales como drivers vpn, o filtros de spam, de virus o de spyware.</p>  


<h3>Consulte tambi&eacute;n</h3>
<ul>
<li><code class="directive">Protocol</code></li>
</ul>
</div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="acceptpathinfo">Directiva <span id="AcceptPathInfo">AcceptPathInfo</span> <a title="Enlace permanente" href="#acceptpathinfo" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Los recursos aceptan informaci&oacute;n sobre su ruta</td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>Disponible en Apache httpd 2.0.30 y posteriores</td></tr>
    ...
    <p>Esta directiva controla si las peticiones que contienen informaci&oacute;n sobre la ruta
    que sigue un fichero que existe (o un fichero que no existe pero en un directorio que
    s&iacute; existe) ser&aacute;n aceptadas o denegadas.  La informaci&oacute;n de ruta puede estar disponible
    para los scripts en la variable de entorno <code>PATH_INFO</code>.</p>

    <p>Por ejemplo, asumamos que la ubicaci&oacute;n <code>/test/</code> apunta a
    un directorio que contiene &uacute;nicamente el fichero
    ...
    <dl>
    <dt><code>Off</code></dt><dd>Una petici&oacute;n s&oacute;lo ser&aacute; aceptada si
    se corresponde con una ruta literal que existe.  Por lo tanto, una petici&oacute;n
    con una informaci&oacute;n de ruta despu&eacute;s del nombre de fichero tal como
    <code>/test/here.html/more</code> en el ejemplo anterior devolver&aacute;
    un error 404 NOT FOUND.</dd>

    <dt><code>On</code></dt><dd>Una petici&oacute;n ser&aacute; aceptada si una
    ruta principal de acceso se corresponde con un fichero que existe. El ejemplo
    anterior <code>/test/here.html/more</code> ser&aacute; aceptado si
    <code>/test/here.html</code> corresponde a un fichero v&aacute;lido.</dd>

    <dt><code>Default</code></dt><dd>La gesti&oacute;n de las peticiones
    con informaci&oacute;n de ruta est&aacute; determinada por el <a href="../handler.html">controlador</a> responsable de la petici&oacute;n.
    ...
    es permitirte sobreescribir la opci&oacute;n del controlador
    ...
    basado en <code>PATH_INFO</code>. El controlador principal normalmente rechazar&iacute;a
    la petici&oacute;n, de modo que puedes utilizar la siguiente configuraci&oacute;n para habilitarla
    como script:</p>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="accessfilename">Directiva <span id="AccessFileName">AccessFileName</span> <a title="Enlace permanente" href="#accessfilename" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Nombre del fichero distribuido de configuraci&oacute;n</td></tr>
...
<tr><th><a href="directive-dict.html#Module">M&oacute;dulo:</a></th><td>core</td></tr>
    ...
    <p>Mientras que procesa una petici&oacute;n el servidor busca
    el primer fichero de configuraci&oacute;n existente dentro de un listado de nombres en
    cada directorio de la ruta del documento, si los ficheros distribuidos
    de configuraci&oacute;n est&aacute;n <a href="#allowoverride">habilitados para ese
    ...
    <code>/usr/local/web/index.html</code>, el servidor leer&aacute;
    <code>/.acl</code>, <code>/usr/.acl</code>,
    <code>/usr/local/.acl</code> and <code>/usr/local/web/.acl</code>
    para las directivas, salvo que est&eacute;n deshabilitadas with</p>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="adddefaultcharset">Directiva <span id="AddDefaultCharset">AddDefaultCharset</span> <a title="Enlace permanente" href="#adddefaultcharset" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Default charset parameter to be added when a response
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="allowencodedslashes">Directiva <span id="AllowEncodedSlashes">AllowEncodedSlashes</span> <a title="Enlace permanente" href="#allowencodedslashes" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Determines whether encoded path separators in URLs are allowed to
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="allowoverride">Directiva <span id="AllowOverride">AllowOverride</span> <a title="Enlace permanente" href="#allowoverride" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Types of directives that are allowed in
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="allowoverridelist">Directiva <span id="AllowOverrideList">AllowOverrideList</span> <a title="Enlace permanente" href="#allowoverridelist" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Individual directives that are allowed in
<code>.htaccess</code> files</td></tr>
...
<tr><th><a href="directive-dict.html#Module">M&oacute;dulo:</a></th><td>core</td></tr>
            ...
            version.</p><h3>Consulte tambi&eacute;n</h3>
<ul>
<li><code class="directive"><a href="#accessfilename">AccessFileName</a></code></li>
<li><code class="directive"><a href="#allowoverride">AllowOverride</a></code></li>
<li><a href="../configuring.html">Configuration Files</a></li>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="cgimapextension">Directiva <span id="CGIMapExtension">CGIMapExtension</span> <a title="Enlace permanente" href="#cgimapextension" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Technique for locating the interpreter for CGI
scripts</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="cgipassauth">Directiva <span id="CGIPassAuth">CGIPassAuth</span> <a title="Enlace permanente" href="#cgipassauth" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Enables passing HTTP authorization headers to scripts as CGI
variables</td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>Available in Apache HTTP Server 2.4.13 and later</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="cgivar">Directiva <span id="CGIVar">CGIVar</span> <a title="Enlace permanente" href="#cgivar" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Controls how some CGI variables are set</td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>Available in Apache HTTP Server 2.4.21 and later</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="contentdigest">Directiva <span id="ContentDigest">ContentDigest</span> <a title="Enlace permanente" href="#contentdigest" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Enables the generation of <code>Content-MD5</code> HTTP Response
headers</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="defaultruntimedir">Directiva <span id="DefaultRuntimeDir">DefaultRuntimeDir</span> <a title="Enlace permanente" href="#defaultruntimedir" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Base directory for the server run-time files</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="defaulttype">Directiva <span id="DefaultType">DefaultType</span> <a title="Enlace permanente" href="#defaulttype" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>This directive has no effect other than to emit warnings
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="define">Directiva <span id="Define">Define</span> <a title="Enlace permanente" href="#define" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Define the existence of a variable</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="directory">Directiva <span id="Directory">&lt;Directory&gt;</span> <a title="Enlace permanente" href="#directory" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Enclose a group of directives that apply only to the
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="directorymatch">Directiva <span id="DirectoryMatch">&lt;DirectoryMatch&gt;</span> <a title="Enlace permanente" href="#directorymatch" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Enclose directives that apply to
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="documentroot">Directiva <span id="DocumentRoot">DocumentRoot</span> <a title="Enlace permanente" href="#documentroot" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Directory that forms the main document tree visible
from the web</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="else">Directiva <span id="Else">&lt;Else&gt;</span> <a title="Enlace permanente" href="#else" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Contains directives that apply only if the condition of a
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="elseif">Directiva <span id="ElseIf">&lt;ElseIf&gt;</span> <a title="Enlace permanente" href="#elseif" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Contains directives that apply only if a condition is satisfied
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="enablemmap">Directiva <span id="EnableMMAP">EnableMMAP</span> <a title="Enlace permanente" href="#enablemmap" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Use memory-mapping to read files during delivery</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="enablesendfile">Directiva <span id="EnableSendfile">EnableSendfile</span> <a title="Enlace permanente" href="#enablesendfile" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Use the kernel sendfile support to deliver files to the client</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="error">Directiva <span id="Error">Error</span> <a title="Enlace permanente" href="#error" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Abort configuration parsing with a custom error message</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="errordocument">Directiva <span id="ErrorDocument">ErrorDocument</span> <a title="Enlace permanente" href="#errordocument" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>What the server will return to the client
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="errorlog">Directiva <span id="ErrorLog">ErrorLog</span> <a title="Enlace permanente" href="#errorlog" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Location where the server will log errors</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="errorlogformat">Directiva <span id="ErrorLogFormat">ErrorLogFormat</span> <a title="Enlace permanente" href="#errorlogformat" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Format specification for error log entries</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="extendedstatus">Directiva <span id="ExtendedStatus">ExtendedStatus</span> <a title="Enlace permanente" href="#extendedstatus" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Keep track of extended status information for each 
request</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="fileetag">Directiva <span id="FileETag">FileETag</span> <a title="Enlace permanente" href="#fileetag" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>File attributes used to create the ETag
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="files">Directiva <span id="Files">&lt;Files&gt;</span> <a title="Enlace permanente" href="#files" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Contains directives that apply to matched
filenames</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="filesmatch">Directiva <span id="FilesMatch">&lt;FilesMatch&gt;</span> <a title="Enlace permanente" href="#filesmatch" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Contains directives that apply to regular-expression matched
filenames</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="flushmaxpipelined">Directiva <span id="FlushMaxPipelined">FlushMaxPipelined</span> <a title="Enlace permanente" href="#flushmaxpipelined" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Maximum number of pipelined responses above which they are flushed
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>2.4.47 and later</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="flushmaxthreshold">Directiva <span id="FlushMaxThreshold">FlushMaxThreshold</span> <a title="Enlace permanente" href="#flushmaxthreshold" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Threshold above which pending data are flushed to the
network</td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>2.4.47 and later</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="forcetype">Directiva <span id="ForceType">ForceType</span> <a title="Enlace permanente" href="#forcetype" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Forces all matching files to be served with the specified
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="gprofdir">Directiva <span id="GprofDir">GprofDir</span> <a title="Enlace permanente" href="#gprofdir" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Directory to write gmon.out profiling data to.  </td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="hostnamelookups">Directiva <span id="HostnameLookups">HostnameLookups</span> <a title="Enlace permanente" href="#hostnamelookups" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Enables DNS lookups on client IP addresses</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="httpprotocoloptions">Directiva <span id="HttpProtocolOptions">HttpProtocolOptions</span> <a title="Enlace permanente" href="#httpprotocoloptions" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Modify restrictions on HTTP Request Messages</td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>2.2.32 or 2.4.24 and later</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="if">Directiva <span id="If">&lt;If&gt;</span> <a title="Enlace permanente" href="#if" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Contains directives that apply only if a condition is
satisfied by a request at runtime</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="ifdefine">Directiva <span id="IfDefine">&lt;IfDefine&gt;</span> <a title="Enlace permanente" href="#ifdefine" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Encloses directives that will be processed only
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="ifdirective">Directiva <span id="IfDirective">&lt;IfDirective&gt;</span> <a title="Enlace permanente" href="#ifdirective" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Encloses directives that are processed conditional on the
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="iffile">Directiva <span id="IfFile">&lt;IfFile&gt;</span> <a title="Enlace permanente" href="#iffile" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Encloses directives that will be processed only
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>Available in 2.4.34 and later.</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="ifmodule">Directiva <span id="IfModule">&lt;IfModule&gt;</span> <a title="Enlace permanente" href="#ifmodule" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Encloses directives that are processed conditional on the
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="ifsection">Directiva <span id="IfSection">&lt;IfSection&gt;</span> <a title="Enlace permanente" href="#ifsection" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Encloses directives that are processed conditional on the
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="include">Directiva <span id="Include">Include</span> <a title="Enlace permanente" href="#include" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Includes other configuration files from within
...
wildcard matching available in 2.3.6 and later</td></tr>
    ...
    <code class="directive">Include</code>
    ...
    <code class="directive">Include</code> directive will
    ...
    <code class="directive">Include</code> directive will fail with an
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="includeoptional">Directiva <span id="IncludeOptional">IncludeOptional</span> <a title="Enlace permanente" href="#includeoptional" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Includes other configuration files from within
the server configuration files</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="keepalive">Directiva <span id="KeepAlive">KeepAlive</span> <a title="Enlace permanente" href="#keepalive" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Enables HTTP persistent connections</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="keepalivetimeout">Directiva <span id="KeepAliveTimeout">KeepAliveTimeout</span> <a title="Enlace permanente" href="#keepalivetimeout" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Amount of time the server will wait for subsequent
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="limit">Directiva <span id="Limit">&lt;Limit&gt;</span> <a title="Enlace permanente" href="#limit" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Restrict enclosed access controls to only certain HTTP
methods</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="limitexcept">Directiva <span id="LimitExcept">&lt;LimitExcept&gt;</span> <a title="Enlace permanente" href="#limitexcept" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Restrict access controls to all HTTP methods
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="limitinternalrecursion">Directiva <span id="LimitInternalRecursion">LimitInternalRecursion</span> <a title="Enlace permanente" href="#limitinternalrecursion" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Determine maximum number of internal redirects and nested
subrequests</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="limitrequestbody">Directiva <span id="LimitRequestBody">LimitRequestBody</span> <a title="Enlace permanente" href="#limitrequestbody" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Restricts the total size of the HTTP request body sent
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="limitrequestfields">Directiva <span id="LimitRequestFields">LimitRequestFields</span> <a title="Enlace permanente" href="#limitrequestfields" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Limits the number of HTTP request header fields that
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="limitrequestfieldsize">Directiva <span id="LimitRequestFieldSize">LimitRequestFieldSize</span> <a title="Enlace permanente" href="#limitrequestfieldsize" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Limits the size of the HTTP request header allowed from the
client</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="limitrequestline">Directiva <span id="LimitRequestLine">LimitRequestLine</span> <a title="Enlace permanente" href="#limitrequestline" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Limit the size of the HTTP request line that will be accepted
from the client</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="limitxmlrequestbody">Directiva <span id="LimitXMLRequestBody">LimitXMLRequestBody</span> <a title="Enlace permanente" href="#limitxmlrequestbody" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Limits the size of an XML-based request body</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="location">Directiva <span id="Location">&lt;Location&gt;</span> <a title="Enlace permanente" href="#location" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Applies the enclosed directives only to matching
URLs</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="locationmatch">Directiva <span id="LocationMatch">&lt;LocationMatch&gt;</span> <a title="Enlace permanente" href="#locationmatch" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Applies the enclosed directives only to regular-expression
matching URLs</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="loglevel">Directiva <span id="LogLevel">LogLevel</span> <a title="Enlace permanente" href="#loglevel" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Controls the verbosity of the ErrorLog</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="maxkeepaliverequests">Directiva <span id="MaxKeepAliveRequests">MaxKeepAliveRequests</span> <a title="Enlace permanente" href="#maxkeepaliverequests" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Number of requests allowed on a persistent
connection</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="maxrangeoverlaps">Directiva <span id="MaxRangeOverlaps">MaxRangeOverlaps</span> <a title="Enlace permanente" href="#maxrangeoverlaps" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Number of overlapping ranges (eg: <code>100-200,150-300</code>) allowed before returning the complete
        resource </td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>Available in Apache HTTP Server 2.3.15 and later</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="maxrangereversals">Directiva <span id="MaxRangeReversals">MaxRangeReversals</span> <a title="Enlace permanente" href="#maxrangereversals" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Number of range reversals (eg: <code>100-200,50-70</code>) allowed before returning the complete
        resource </td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>Available in Apache HTTP Server 2.3.15 and later</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="maxranges">Directiva <span id="MaxRanges">MaxRanges</span> <a title="Enlace permanente" href="#maxranges" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Number of ranges allowed before returning the complete
resource </td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>Available in Apache HTTP Server 2.3.15 and later</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="mergeslashes">Directiva <span id="MergeSlashes">MergeSlashes</span> <a title="Enlace permanente" href="#mergeslashes" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Controls whether the server merges consecutive slashes in URLs.
</td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>Added in 2.4.39</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="mergetrailers">Directiva <span id="MergeTrailers">MergeTrailers</span> <a title="Enlace permanente" href="#mergetrailers" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Determines whether trailers are merged into headers</td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>2.4.11 and later</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="mutex">Directiva <span id="Mutex">Mutex</span> <a title="Enlace permanente" href="#mutex" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Configures mutex mechanism and lock file directory for all
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="namevirtualhost">Directiva <span id="NameVirtualHost">NameVirtualHost</span> <a title="Enlace permanente" href="#namevirtualhost" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Designates an IP address for name-virtual
hosting</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="options">Directiva <span id="Options">Options</span> <a title="Enlace permanente" href="#options" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Configures what features are available in a particular
directory</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="protocol">Directiva <span id="Protocol">Protocol</span> <a title="Enlace permanente" href="#protocol" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Protocol for a listening socket</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="protocols">Directiva <span id="Protocols">Protocols</span> <a title="Enlace permanente" href="#protocols" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Protocols available for a server/virtual host</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="protocolshonororder">Directiva <span id="ProtocolsHonorOrder">ProtocolsHonorOrder</span> <a title="Enlace permanente" href="#protocolshonororder" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Determines if order of Protocols determines precedence during negotiation</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="qualifyredirecturl">Directiva <span id="QualifyRedirectURL">QualifyRedirectURL</span> <a title="Enlace permanente" href="#qualifyredirecturl" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Controls whether the REDIRECT_URL environment variable is
...
as if 'QualifyRedirectURL On' was configured.</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="readbuffersize">Directiva <span id="ReadBufferSize">ReadBufferSize</span> <a title="Enlace permanente" href="#readbuffersize" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Size of the buffers used to read data</td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>2.4.27 and later</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="regexdefaultoptions">Directiva <span id="RegexDefaultOptions">RegexDefaultOptions</span> <a title="Enlace permanente" href="#regexdefaultoptions" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Allow to configure global/default options for regexes</td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>Only available from Apache 2.4.30 and later.</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="registerhttpmethod">Directiva <span id="RegisterHttpMethod">RegisterHttpMethod</span> <a title="Enlace permanente" href="#registerhttpmethod" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Register non-standard HTTP methods</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="rlimitcpu">Directiva <span id="RLimitCPU">RLimitCPU</span> <a title="Enlace permanente" href="#rlimitcpu" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Limits the CPU consumption of processes launched
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="rlimitmem">Directiva <span id="RLimitMEM">RLimitMEM</span> <a title="Enlace permanente" href="#rlimitmem" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Limits the memory consumption of processes launched
by Apache httpd children</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="rlimitnproc">Directiva <span id="RLimitNPROC">RLimitNPROC</span> <a title="Enlace permanente" href="#rlimitnproc" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Limits the number of processes that can be launched by
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="scriptinterpretersource">Directiva <span id="ScriptInterpreterSource">ScriptInterpreterSource</span> <a title="Enlace permanente" href="#scriptinterpretersource" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Technique for locating the interpreter for CGI
scripts</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="seerequesttail">Directiva <span id="SeeRequestTail">SeeRequestTail</span> <a title="Enlace permanente" href="#seerequesttail" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Determine if mod_status displays the first 63 characters
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="serveradmin">Directiva <span id="ServerAdmin">ServerAdmin</span> <a title="Enlace permanente" href="#serveradmin" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Email address that the server includes in error
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="serveralias">Directiva <span id="ServerAlias">ServerAlias</span> <a title="Enlace permanente" href="#serveralias" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Alternate names for a host used when matching requests
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="servername">Directiva <span id="ServerName">ServerName</span> <a title="Enlace permanente" href="#servername" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Hostname and port that the server uses to identify
itself</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="serverpath">Directiva <span id="ServerPath">ServerPath</span> <a title="Enlace permanente" href="#serverpath" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Legacy URL pathname for a name-based virtual host that
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="serverroot">Directiva <span id="ServerRoot">ServerRoot</span> <a title="Enlace permanente" href="#serverroot" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Base directory for the server installation</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="serversignature">Directiva <span id="ServerSignature">ServerSignature</span> <a title="Enlace permanente" href="#serversignature" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Configures the footer on server-generated documents</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="servertokens">Directiva <span id="ServerTokens">ServerTokens</span> <a title="Enlace permanente" href="#servertokens" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Configures the <code>Server</code> HTTP response
header</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="sethandler">Directiva <span id="SetHandler">SetHandler</span> <a title="Enlace permanente" href="#sethandler" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Forces all matching files to be processed by a
handler</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="setinputfilter">Directiva <span id="SetInputFilter">SetInputFilter</span> <a title="Enlace permanente" href="#setinputfilter" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Sets the filters that will process client requests and POST
input</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="setoutputfilter">Directiva <span id="SetOutputFilter">SetOutputFilter</span> <a title="Enlace permanente" href="#setoutputfilter" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Sets the filters that will process responses from the
server</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="stricthostcheck">Directiva <span id="StrictHostCheck">StrictHostCheck</span> <a title="Enlace permanente" href="#stricthostcheck" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Controls whether the server requires the requested hostname be
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>Added in 2.4.49</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="timeout">Directiva <span id="TimeOut">TimeOut</span> <a title="Enlace permanente" href="#timeout" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Amount of time the server will wait for
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="traceenable">Directiva <span id="TraceEnable">TraceEnable</span> <a title="Enlace permanente" href="#traceenable" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Determines the behaviour on <code>TRACE</code> requests</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="unclist">Directiva <span id="UNCList">UNCList</span> <a title="Enlace permanente" href="#unclist" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Controls what UNC host names can be accessed by the server
</td></tr>
...
<tr><th><a href="directive-dict.html#Compatibility">Compatibilidad:</a></th><td>Added in 2.4.60, Windows only.</td></tr>
            ...
            version.</p></div>
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="undefine">Directiva <span id="UnDefine">UnDefine</span> <a title="Enlace permanente" href="#undefine" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Undefine the existence of a variable</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="usecanonicalname">Directiva <span id="UseCanonicalName">UseCanonicalName</span> <a title="Enlace permanente" href="#usecanonicalname" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Configures how the server determines its own name and
port</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="usecanonicalphysicalport">Directiva <span id="UseCanonicalPhysicalPort">UseCanonicalPhysicalPort</span> <a title="Enlace permanente" href="#usecanonicalphysicalport" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Configures how the server determines its own name and
port</td></tr>
...
<div class="top"><a href="#page-header"><img alt="top" src="../images/up.gif"></a></div>
<div class="directive-section"><h2 id="virtualhost">Directiva <span id="VirtualHost">&lt;VirtualHost&gt;</span> <a title="Enlace permanente" href="#virtualhost" class="permalink">&para;</a></h2>
<table class="directive">
<tr><th><a href="directive-dict.html#Description">Descripci&oacute;n:</a></th><td>Contains directives that apply only to a specific
