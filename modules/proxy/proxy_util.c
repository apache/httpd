...
PROXY_DECLARE(int) ap_proxy_pre_http_request(conn_rec *c, request_rec *r)
{
    ...
    ap_add_input_filter("HTTP1_REQUEST_IN", NULL, r, c);
    return OK;
}
                                            ...
                                            char **old_te_val)
{
    ...
    if (dconf->preserve_host == 0) {
        ...
        apr_table_setn(request_headers, "Host", nhost);
    }
    else {
        ...
        if (!hostname) {
            ...
            ap_log_rerror(APLOG_MARK, APLOG_WARNING, 0, r, APLOGNO(01092)
                          ...
                          hostname, r->uri);
            apr_table_setn(request_headers, "Host", hostname);
        }
    }
    ...
    ap_http1_append_headers(header_brigade, r, request_headers);
