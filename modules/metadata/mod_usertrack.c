...
static const command_rec cookie_log_cmds[] = {
    ...
    AP_INIT_FLAG_SLOT("CookieTracking", cookie_dir_rec, enabled, OR_FILEINFO,
    ...
    AP_INIT_TAKE1("CookieSameSite", set_samesite_value, NULL, OR_FILEINFO,
                  "SameSite setting"),
    AP_INIT_FLAG_SLOT("CookieSecure", cookie_dir_rec, is_secure, OR_FILEINFO,
                      "is cookie secure"),
    AP_INIT_FLAG_SLOT("CookieHttpOnly", cookie_dir_rec, is_httponly,
                      OR_FILEINFO, "is cookie http only"),
