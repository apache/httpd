...
AP_DECLARE_DATA ap_filter_rec_t *ap_http1_body_in_filter_handle;
...
static void register_hooks(apr_pool_t *p)
{
    ...
    ap_http1_body_in_filter_handle =
        ap_register_input_filter("HTTP1_BODY_IN", ap_http1_body_in_filter,
